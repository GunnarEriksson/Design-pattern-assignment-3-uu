...
public enum FileFormats 
{
	...
	/**
	 * Returns a map with all possible files types.
	 * 
	 * @return map with all possible file types
	 */
	public static Map<String, FileIO> getFileHandlerMap()
	{
	    Map<String, FileIO> fileHandling = new HashMap<String, FileIO>();
	    fileHandling.put(FileFormats.TEXT.toString(), new TextFile());
        fileHandling.put(FileFormats.XML.toString(), new XmlFile());
