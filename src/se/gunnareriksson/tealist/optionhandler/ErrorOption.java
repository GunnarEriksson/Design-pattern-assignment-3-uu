/**
 * Handles the Error option in the request.
 * 
...
public class ErrorOption extends OptionHandler 
{
    /**
     * Constructor
     ...
     */
    public ErrorOption(Map<String, OptionHandler> optionHandling) 
    {
        this.optionHandling = optionHandling;
    }

    /**
     * Adds the option Error to the request map.
     * 
