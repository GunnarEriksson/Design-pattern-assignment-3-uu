/**
 * Handles the Help option in the request.
 * 
...
public class HelpOption extends OptionHandler 
{
    /**
     * Constructor
     ...
     */
    public HelpOption(Map<String, OptionHandler> optionHandling) 
    {
        this.optionHandling = optionHandling;
    }

    /**
     * Adds the option Help to the request map.
     * 
    ...
    {
        requestMap.put(Options.HELP, null);
